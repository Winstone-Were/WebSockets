...
class DataBase {
    constructor(){
        fs.readFile('C:/Users/Winstone/Desktop/Web Development/Plug Chat/Database/database.json',(err,data)=>{
            if(err) return err;
    ...
    writeToDb(obj){
        this.initiateDB().catch(err=>console.log(err))
            .then(data=>{
                ...
                tmp = JSON.parse(data);
                tmp.push(obj);
                fs.writeFile('C:/Users/Winstone/Desktop/Web Development/Plug Chat/Database/database.json',JSON.stringify(tmp),(err)=>{
    ...
    writeArrayToDb(arr){
        fs.writeFile('C:/Users/Winstone/Desktop/Web Development/Plug Chat/Database/database.json',JSON.stringify(arr),(err)=>{
            if(err) console.log(err);
            else console.log("success");
        })
    }
